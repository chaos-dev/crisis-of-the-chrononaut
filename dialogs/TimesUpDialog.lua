...
function _M:init(actor)
  self.actor = actor
  Dialog.init(self, "Time is Over!", 500, 300)

  self:generateList()

  self.c_desc = Textzone.new{width=self.iw, auto_height=true, text=[[As you struggle onward, the high whining of the rifts becomes louder and louder, till you have to clap you hands over your ears in pain. The rifts flash more rapidly and begin to merge into a single, giant blob of light. Their kaleidoscope of colors beats upon your eyes.

  And suddenly... it's all over.  You feel nothing, and are surrounded by nothing.

  Only light and a horrible void of nothing.
  ]]}
